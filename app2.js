...
app.get('/', (req, res, next) => {
    ...
    matkat.forEach((matka)=>{
        ...
        <tr>
            ...
            <td><form action="poista-rivi" method="POST">
                    <input type="hidden" name="rivi_id" value="${matka.indeksi}">
                    <button type="submit">Poista rivi</button>
                </form>
            </td>
            <br>
        </tr>
...
app.post('/poista-rivi', (req,res,next)=>{
    var poistettava = req.body.rivi_id;
    matkat = matkat.filter((matkat.indeksi) => matkat.indeksi !== poistettava)
